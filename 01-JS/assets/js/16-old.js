...
var NbDeMembres = membres.length;
var i=0;

console.log(NbDeMembres);

pseudo="";
function VerifPseudo(){
    // while (pseudo !== "TheWarriorMaster")
    
    for (let i=0 ; i < NbDeMembres; i++ ) 
        {
        membres[i].pseudo === pseudo;
        pseudo.addEventListener ('change', pseudo );
        console.log(NbDeMembres);
        console.log("login tapé = " , pseudo);
        }
}
